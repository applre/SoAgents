...
- **温暖**：奶油白纸张质感背景，暖棕色调，长时间使用不疲劳
- **专业**：清晰的信息层级，稳定可信赖的工具感
- **高效**：快速响应，不打断用户心流，信息密度适当

**情绪目标**：用户打开 SoAgents 应感到舒适和信任，像坐在光线充足的书房里使用一本精心装帧的笔记本。

### 美学方向

**视觉基调**：温暖纸张质感 (Warm Paper Texture) — 介于极简工具和精致创意应用之间

**参考方向**：
- **Apple 原生应用** — macOS 系统级原生质感、动效克制、信息层级清晰
- **Notion / Arc** — 温暖精致的色调、创意工具的亲和力
- **Linear / Raycast** — 开发者工具的极简高效、键盘优先、信息密度

**反面参考（应避免）**：过度装饰/渐变泛滥的 Web3 风格、冰冷机械的纯灰色系、信息过载的仪表盘风格
...
3. **温暖但克制 (Warm but Restrained)** — 暖色调营造亲和感，但装饰极少。颜色用于语义传达，不用于装饰。动效克制
